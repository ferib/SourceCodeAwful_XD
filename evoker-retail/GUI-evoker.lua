...
local dispelOptional = {
    ...
    { label = awful.textureEscape(191587, 22).."Virulent Plague", value = 191587},
    { label = awful.textureEscape(283499, 22).."Frost Fever", value = 283499},
    { label = awful.textureEscape(1943, 22).."Rupture", value = 1943},
    { label = awful.textureEscape(703, 22).."Garrote", value = 703},
    { label = awful.textureEscape(118000, 22).."Dragon Roar", value = 118000},
...
local dispels = gui:Tab("DISPEL CURSE/BLEED/POISON")
dispels:Dropdown({
	var = "dispelsList",
	multi = true,
...
defensives:Slider({
	text = "Obsidian Scales",
	var = "defensiveObsidianScales",
	min = 0,
	max = 100,
	default = 50,
	valueType = "%",
	tooltip = "What % to use Obsidian Scales"
})
defensives:Slider({
	text = "Renewing Blaze",
	var = "defensiveRenewingBlaze",
	min = 0,
	max = 100,
	default = 50,
	valueType = "%",
	tooltip = "What % to use Renewing Blaze"
})
defensives:Slider({
	text = "Healthstone",
