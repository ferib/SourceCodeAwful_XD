...
awful.DevMode = true
if awful.player.class2 ~= "DRUID" then return end
...
toggleDpsCds:Checkbox({
  text = "Auto Incarnation Chosen of Elune",
  var = "autoIncarnationChosenOfElune",
  default = true,
})
...
interrupts:Checkbox({
  text = "CC Enemy Healer Only (SolarBeam)      ",
  var = "CCHealerOnly",
  default = true,
})
...
sheeps:Checkbox({
  text = "Mighty Bash Melee                    ",
  var = "BashMelee",
  default = true,
})
sheeps:Checkbox({
  text = "Mighty Bash Healer When in Range (10 yards)",
  var = "BashHealer",
  default = true,
})
...
defensives:Slider({
	text = "Renewal",
	var = "defensiveRenewal",
	min = 0,
	max = 100,
	default = 70,
	valueType = "%",
	tooltip = "What % to use Renewal"
})
defensives:Slider({
	text = "Bark Skin",
	var = "defensiveBarkSkin",
	min = 0,
	max = 100,
	default = 40,
	valueType = "%",
	tooltip = "What % to use Bark Skin"
})
defensives:Slider({
	text = "Frenzied Regeneration",
	var = "defensivesFrenziedRegeneration",
	min = 0,
	max = 100,
	default = 60,
	valueType = "%",
	tooltip = "What % to use Frenzied Regeneration"
})
defensives:Slider({
	text = "Healthstone",
...
defensives:Slider({
	text = "Stay in Bear Form",
	var = "bearformHp",
	min = 0,
	max = 100,
	default = 30,
	valueType = "%",
	tooltip = "What % to use stay in BearForm"
})
defensives:Slider({
	text = "Rejuvenation/SwiftMend",
	var = "rejuvenationSwiftMend",
	min = 0,
	max = 100,
	default = 50,
	valueType = "%",
	tooltip = "What % to use Rejuvenation/SwiftMend"
})
defensives:Slider({
	text = "Nature's Vigil",
	var = "naturesVigilDef",
	...
	default = 70,
	valueType = "%",
	tooltip = "What % to use naturesVigil"
})
